"""
Django settings for beBrivus project.
"""
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-4t2k#-s0%u5dit!-=$rgfh98l-miu_o@uo*ed%7itdyn9&7rd(')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config('DEBUG', default='True', cast=lambda v: v.lower() in ('true', '1', 'yes') if isinstance(v, str) else bool(v))
...
EMAIL_HOST_PASSWORD = (
    ...
    .strip('"')
    .strip("'")
    .replace(' ', '')  # Remove ALL spaces - app passwords must have no spaces
)
DEFAULT_FROM_EMAIL = f'beBrivus <{EMAIL_HOST_USER}>'
SERVER_EMAIL = EMAIL_HOST_USER
ADMIN_EMAIL = 'ethxkeys@gmail.com'
